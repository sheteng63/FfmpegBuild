...
jstring Java_com_example_ffpengbuild_MainActivity_stringFromJNI(
        JNIEnv *env,
        jobject /* this */) {
...
Java_com_example_ffpengbuild_MainActivity_play(JNIEnv *env, jobject instance,
